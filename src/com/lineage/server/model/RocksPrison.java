 ...
 * @version 1.0
 * @author jrwz
 * @data 2013-5-9上午11:57:49
 */
public final class RocksPrison extends TimerTask {
    /** 提示信息. */
    private static final Log _log = LogFactory.getLog(RocksPrison.class);
    ...
    private void showTime(final int maxTime) {
    	if (this._pc.isShow()) {
    		this._pc.setShow(false);
            final int time = this._pc.getRocksPrisonTime();
            _pc.sendPackets(new S_PacketBox(0, maxTime - time, null));
    	}
    }
