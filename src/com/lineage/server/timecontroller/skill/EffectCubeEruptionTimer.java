...
public class EffectCubeEruptionTimer extends TimerTask {
    ...
    private static final Log _log = LogFactory
            .getLog(EffectCubeEruptionTimer.class);
    ...
    public void run() {
        try {
            ...
            /*
             * for (final L1EffectInstance effect : allNpc) { // 不是幻术师技能(立方：地裂)
             * if (effect.effectType() != L1EffectType.isCubeEruption) {
            ...
            _log.error("Npc L1Effect幻术师技能(立方：地裂)状态送出时间轴异常重启", e);
