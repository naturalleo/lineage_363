...
/**
 * <font color=#00800>法令军王印记盒40636</font><BR>
...
public class Box_DarkSpiritArmy extends ItemExecutor {
    ...
    public void execute(final int[] data, final L1PcInstance pc,
        ...
        switch (k) {
            ...
            case 98:
                item_id = 20109;// 法令军王长袍
                break;

            case 99:
            	final int m = (int) (Math.random() * 100);// 随机数字范围0~99
            	if (m > 70) {
                    item_id = 20253;// 法令军王之炼 //修改法令军王之炼 的机率 hjx1000
            	} else {
            		item_id = 20109;// 法令军王长袍
            	}
                break;
