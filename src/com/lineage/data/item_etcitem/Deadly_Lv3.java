...
/**
 * 武器致命魔法卷轴lv3 55113<br>
 */
public class Deadly_Lv3 extends ItemExecutor {
    ...
    public void execute(final int[] data, final L1PcInstance pc,
        ...
        boolean isErr = false;
        if (power_name == null) {
        	pc.sendPackets(new S_SystemMessage("这个卷轴只可以强化Lv2的武器。"));
        	return;
        }
        if (power_name.get_xing_count() != 2) {
        	pc.sendPackets(new S_SystemMessage("这个卷轴只可以强化Lv2的武器。"));
        	return;
        }
        // 取得物件触发事件
