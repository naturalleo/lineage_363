 ...
 * 三星對盔甲施法的卷軸<br>
 */
public class ScrollEnchantArmor_3xing extends ItemExecutor {

	/**
	 *
	 */
	private ScrollEnchantArmor_3xing() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new ScrollEnchantArmor_3xing();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		case 25:// 盾牌
			...
			if (power_name != null && tgItem.get_power_name().get_xing_count() > 2) { //三星防具	
				is3xing = true;
				if (tgItem.get_power_name().get_xing_count() > 3) {//防具星数 大于3不能强化hjx1000
					isErr = true;
				}				
			}
			break;
		...
		if (enchant_level < -6) {// 盔甲将会消失,最大可追加到-7
			...
			if (!is3xing && rnd3 < Super) {//星防具成功机率 hjx1000
