 ...
 *
 */
public class GM_ScrollEnchantWeapon_3xing extends ItemExecutor {

	/**
	 *
	 */
	private GM_ScrollEnchantWeapon_3xing() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new GM_ScrollEnchantWeapon_3xing();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		final int Super = 200; //超安定值数 hjx1000
