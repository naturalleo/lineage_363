 ...
 * 二星對盔甲施法的卷軸<br>
 */
public class ScrollEnchantArmor_2xing extends ItemExecutor {

	/**
	 *
	 */
	private ScrollEnchantArmor_2xing() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new ScrollEnchantArmor_2xing();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		case 25:// 盾牌
			...
			if (power_name != null && tgItem.get_power_name().get_xing_count() > 1) { //二星防具	
				is2xing = true;
				if (tgItem.get_power_name().get_xing_count() > 2) {//防具星数 大于2不能强化hjx1000
					isErr = true;
				}				
			}
			break;
		...
		if (enchant_level < -6) {// 盔甲将会消失,最大可追加到-7
			...
			if (!is2xing && rnd3 < Super) {//星防具成功机率 hjx1000
