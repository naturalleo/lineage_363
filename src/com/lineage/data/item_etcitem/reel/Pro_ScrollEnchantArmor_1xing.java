 ...
 * 百分百一星防卷<br>
 */
public class Pro_ScrollEnchantArmor_1xing extends ItemExecutor {

	/**
	 *
	 */
	private Pro_ScrollEnchantArmor_1xing() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new Pro_ScrollEnchantArmor_1xing();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		case 25:// 盾牌
			...
			if (power_name != null) {
				is3xing = true;
				if (tgItem.get_power_name().get_xing_count() > 3) {
					isErr = true;
				}				
			}
			break;
