 ...
 * 三星對盔甲施法的卷軸<br>
 */
public class GM_ScrollEnchantArmor_3xing extends ItemExecutor {

	/**
	 *
	 */
	private GM_ScrollEnchantArmor_3xing() {
		// TODO Auto-generated constructor stub
	}

	public static ItemExecutor get() {
		return new GM_ScrollEnchantArmor_3xing();
	}
	...
	public void execute(final int[] data, final L1PcInstance pc, final L1ItemInstance item) {
		...
		case 25:// 盾牌
			...
			if (power_name != null && tgItem.get_power_name().get_xing_count() > 8) { //三星防具	
				is3xing = true;
				if (tgItem.get_power_name().get_xing_count() > 8) {//防具星数 大于3不能强化hjx1000
					isErr = true;
				}				
			}
			break;
